...
public class MyDexClassLoader extends ClassLoader {
    ...
    * {@link MyDexClassLoader#setReporter}.
    */
    ...
    */
        public MyDexClassLoader(String dexPath, File optimizedDirectory,
    ...
    */
        private void reportClassLoaderChain() {
            ArrayList<MyDexClassLoader> classLoadersChain = new ArrayList<>();
            ArrayList<String> classPaths = new ArrayList<>();

            classLoadersChain.add(this);
            classPaths.add(TextUtils.join(File.pathSeparator, pathList.getDexPaths()));
            ...
            while (current != null && current != bootClassLoader) {
               if (current instanceof MyDexClassLoader) {
                   MyDexClassLoader bdcCurrent = (MyDexClassLoader) current;
                       classLoadersChain.add(bdcCurrent);
                        classPaths.add(TextUtils.join(File.pathSeparator, bdcCurrent.pathList.getDexPaths()));
                    } else {
     ...
     * @hide
     */
        public MyDexClassLoader(ByteBuffer[] dexFiles, ClassLoader parent) {
   ...
   protected synchronized Package getPackage(String name) {
     ...
     */
       ...
       /**
         ...
         */
       void report(List<MyDexClassLoader> classLoadersChain, List<String> classPaths);
   }
